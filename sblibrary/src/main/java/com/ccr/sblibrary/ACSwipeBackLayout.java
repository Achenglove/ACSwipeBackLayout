 ...
 */
public class ACSwipeBackLayout extends ViewGroup {
     ...
     * 滑动返回时的阴影视图
     */
    private ACSwipeBackShadowView mShadowView;
    /**
     * 内容视图
     */
    ...
    void attachToActivity(Activity activity) {
        ...
        mShadowView = new ACSwipeBackShadowView(activity);
    ...
    private boolean isSwipeBackEnable() {
        return mSwipeBackEnable && ACSwipeBackManager.getInstance().isSwipeBackEnable();
    }
    ...
    public ACSwipeBackLayout(Context context) {
        this(context, null);
    }

    public ACSwipeBackLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ACSwipeBackLayout(Context context, AttributeSet attrs, int defStyle) {
...
//        int widthSize = MeasureSpec.getSize(widthMeasureSpec);
        int widthSize = ACUIUtil.getRealScreenWidth(mActivity);
//        int heightSize = MeasureSpec.getSize(heightMeasureSpec);
        int heightSize = ACUIUtil.getRealScreenHeight(mActivity);
        // ======================== 新加的 END ========================
        ...
        // ======================== 新加的 START ========================
        if (!mIsNavigationBarOverlap && ACUIUtil.isPortrait(mActivity)) {
            maxLayoutHeight -= ACUIUtil.getNavigationBarHeight(mActivity);
        }

        if (mIsNavigationBarOverlap && !ACUIUtil.isPortrait(mActivity)) {
            widthSize += ACUIUtil.getNavigationBarHeight(mActivity);
        }
        // ======================== 新加的 END ========================
...
//            mDragHelper.captureChildView(mSlideableView, pointerId);
    ...
    interface SlidingPanelLayoutImpl {
        void invalidateChildRegion(ACSwipeBackLayout parent, View child);
    }

    static class SlidingPanelLayoutImplBase implements SlidingPanelLayoutImpl {
        @Override
        public void invalidateChildRegion(ACSwipeBackLayout parent, View child) {
    ...
    class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
            ...
            info.setClassName(ACSwipeBackLayout.class.getName());
            info.setSource(host);
        ...
        public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
            ...
            event.setClassName(ACSwipeBackLayout.class.getName());
        }
