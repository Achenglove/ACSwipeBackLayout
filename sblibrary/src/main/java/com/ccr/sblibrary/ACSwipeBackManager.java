 ...
 *
 */
class ACSwipeBackManager implements Application.ActivityLifecycleCallbacks {
    private static final ACSwipeBackManager sInstance = new ACSwipeBackManager();
    private Stack<Activity> mActivityStack = new Stack<>();
    private Set<Class<? extends View>> mProblemViewClassSet = new HashSet<>();

    public static ACSwipeBackManager getInstance() {
        return sInstance;
    }

    private ACSwipeBackManager() {
    }
